...
/**
 * Extend from AsyncTask
 *
 * @param <Params>
 * @param <Progress>
 * @param <Result>
 */
public abstract class ExtAsyncTask<Params, Progress, Result> {
   private static final String                   LOG_TAG = "ExtAsyncTask";
   ...
   private static final BlockingQueue<Runnable>  sWorkQueue =
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "ExtAsyncTask #" + mCount.getAndIncrement());
        }
    };
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL, new AsyncTaskResult<Result>(ExtAsyncTask.this,
                            (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT, new AsyncTaskResult<Result>(ExtAsyncTask.this, result));
                message.sendToTarget();
            }
        };
    }
     ...
     * <tt>mayInterruptIfRunning</tt> parameter determines whether the thread executing this task should be interrupted in an
     * attempt to stop the task.
     * 
     * @param mayInterruptIfRunning
     *            <tt>true</tt> if the thread executing this task should be interrupted; otherwise, in-progress tasks are allowed
     *            to complete.
     * 
     ...
     */
    public final Result getResult(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException {
        return mFuture.get(timeout, unit);
    }

    /**
     * Executes the task with the specified parameters. The task returns itself (this) so that the caller can keep a reference to
     * it.
     * 
     ...
     */
    public final ExtAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * computation is still running. Each call to this method will trigger the execution of {@link #onProgressUpdate} on the UI
     * thread.
     * 
     * @param values
    ...
    private static class AsyncTaskResult<Data> {
        final ExtAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(ExtAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
